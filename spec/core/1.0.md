...
For each official module (see section 3.3) that describes platform requirements, the specification for the platform integration module MUST define how these requirements are met on the platform defined by it.
...
The following platform integration modules are known at the time of publication of this document:
