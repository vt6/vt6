...
- To implement connection-lifetime-specific properties, each client gets a lifetime UUID from their parent in their vt6ack message. They have to include their lifetime in core.set messages. Once they've died, their parent announces the end of their lifetimes to the terminal.
