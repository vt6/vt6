...
- If the client ID belongs to a child process in that job, the message MUST be copied onto the shell's message input unchanged.
...
- If the client ID belongs to a child process in that job, the message MUST be copied onto the shell's message output unchanged.
- Otherwise, the message MUST be discarded.
